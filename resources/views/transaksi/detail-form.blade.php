<form method="post" action="{{ route('transaksi.update', ['transaksi' => $transaksi->id]) }}" class="card-body border-top">
    @csrf
    @method('put')
    <div class="row">
        <div class="col">
        ...
        <div class="col">
            ...
            <div class="form-group row">
                                ...
                                @if ($transaksi->status == 'baru')
                                    <a href="{{ route('transaksi.status', ['transaksi' => $transaksi->id, 'status' => 'proses']) }}"
                                        ...
                                        {{-- <a href="{{ route('transaksi.status', ['transaksi' => $transaksi->id, 'status' => 'batal']) }}"
                                            class="dropdown-item">Dibatalkan</a> --}}
                ...
                <div class="col">
                    <button type="submit" class="btn btn-info btn-block"><i class="fas fa-database"></i> Update Pembayaran</button>
                </div>
            </div>
        </div>
    </div>
