            ...
            <div class="card-body p-0">
                <table class="table table-striped table-hover m-0">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="10" class="text-center">Tidak ada paket dipilih</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
            <form method="post" action="{{ route('transaksi.store', ['member' => $member->id]) }}"
                    ...
                    <div class="col">
                        ...
                        <div class="form-group row">
                            <div class="col">
                                ...
                                <a href="{{ route('transaksi.clear', ['member' => $member->id]) }}"
